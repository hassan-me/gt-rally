...
export const blogArticles = [
  {
    ...
    date: "January 28, 2024",
    admin: "Lucas Grant",
    category: "Rally Insights",
    title: "Mastering the Art of Off-Road Rally Driving",
    description:
      "Discover expert tips and techniques to navigate rough terrains like a pro. From handling sharp turns to controlling speed, this guide has it all!",
  },
  {
    id: 19,
    ...
    title: "Top 5 Rally Tracks You Must Conquer This Year",
    description:
      "From the dusty deserts of Dakar to the icy roads of Sweden, explore the most exhilarating rally tracks every racing enthusiast should experience.",
  },
  {
    id: 20,
    imgSrc: "/assets/images/blog/blog-17.jpg",
    date: "January 30, 2024",
    admin: "Ethan Harrison",
    category: "Gear & Upgrades",
    title: "Essential Mods to Boost Your Rally Car’s Performance",
    description:
      "Looking to enhance your rally car’s speed, grip, and durability? We break down the best modifications that will give you an edge in any competition.",
  },
  {
    id: 21,
    ...
    title: "Behind the Scenes: What Goes into Organizing a Rally?",
    description:
      "Ever wondered what it takes to host a high-speed rally event? Get an inside look at logistics, safety measures, and the thrill of race day!",
  },
];
